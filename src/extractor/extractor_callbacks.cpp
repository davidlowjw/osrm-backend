...
void ExtractorCallbacks::ProcessWay(const osmium::Way &input_way, const ExtractionWay &parsed_way)
{
    ...
    if (data)
    {
        road_classification.road_class = engine::guidance::functionalRoadClassFromTag(data);
    }
    const char *feature = input_way.get_value_by_key("feature_id");
    if (feature)
    {
        road_classification.feature_id = std::stoi(feature);
    }
